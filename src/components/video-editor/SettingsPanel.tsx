...
export function SettingsPanel({
	...
	const effectSectionContent = (() => {
		...
		const sceneSectionContent = (
			<div className="space-y-4">
				{(onRecordScreen || onImportFile) && (
					<div className="flex gap-2">
						{onRecordScreen && (
							<button
								type="button"
								onClick={onRecordScreen}
								className="group relative flex flex-1 items-center justify-center gap-2 rounded-lg border border-red-500/30 bg-red-500/10 px-4 py-2.5 text-sm font-semibold text-red-400 transition-all hover:bg-red-500/20 hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
							>
