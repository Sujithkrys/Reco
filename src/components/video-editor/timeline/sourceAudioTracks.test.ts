...
describe("timeline source audio tracks", () => {
	it("builds candidates for Windows and macOS sidecar containers", () => {
		expect(buildSourceSidecarPathCandidates("C:\\Reco\\recording-1.mp4", "mic")).toEqual([
			"C:/Reco/recording-1.mic.wav",
			"C:/Reco/recording-1.mic.m4a",
			"C:/Reco/recording-1.mic.webm",
		]);
	});
