...
export type ZoomTransitionEasing = "reco" | "glide" | "smooth" | "snappy" | "linear";
...
export const DEFAULT_ZOOM_IN_EASING: ZoomTransitionEasing = "reco";
export const DEFAULT_ZOOM_OUT_EASING: ZoomTransitionEasing = "reco";
