...
export default function EditorDashboard({
	...
	return (
		<div className="flex h-full w-[320px] flex-col overflow-y-auto bg-editor-panel text-foreground shadow-[1px_0_0_0_rgba(255,255,255,0.05)]">
			<div className="flex flex-col gap-6 p-5">
				<header className="flex flex-col gap-3">
					...
					<button
						...
						className="group relative flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_4px_14px_rgba(37,99,235,0.3)] transition-all hover:bg-blue-500 hover:shadow-[0_6px_20px_rgba(37,99,235,0.4)] hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
					>
						<svg
							...
							{recentProjects.map((entry) => {
								...
								return (
									<button
										...
										className="group flex items-center gap-3 rounded-lg border border-transparent bg-foreground/[0.02] p-1.5 text-left outline-none transition hover:bg-foreground/[0.06] hover:border-foreground/10 focus-visible:ring-2 focus-visible:ring-blue-500"
									>
										<div className="relative aspect-[16/10] w-[72px] flex-shrink-0 overflow-hidden rounded-md bg-foreground/5 shadow-sm ring-1 ring-foreground/10 transition group-hover:shadow-md">
											{thumbnailSrc ? (
												<img
													src={thumbnailSrc}
													alt=""
										...
										<div className="flex min-w-0 flex-col py-0.5">
											<div className="truncate text-xs font-semibold tracking-tight text-foreground/90 transition-colors group-hover:text-foreground">
												{entry.name}
											</div>
