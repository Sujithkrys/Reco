					...
					.then(async () => {
						...
						if (!safeMeta.decoderConfig) {
							safeMeta.decoderConfig = {
								...
								sampleRate: encodeConfig.sampleRate,
								numberOfChannels: encodeConfig.numberOfChannels,
							};
						} else if (!safeMeta.decoderConfig.codec) {
							safeMeta.decoderConfig = {
								...safeMeta.decoderConfig,
								codec: encodeConfig.codec,
							};
						}
						await muxer.addAudioChunk(chunk, !wroteFirstChunk ? safeMeta : undefined);
