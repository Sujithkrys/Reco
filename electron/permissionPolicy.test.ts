...
const TRUSTED_DOCUMENT_BASE_URLS = [
	...
	"file:///C:/Program%20Files/Reco/resources/app.asar/dist/index.html",
];
...
const FILE_HUD_URL =
	"file:///C:/Program%20Files/Reco/resources/app.asar/dist/index.html?windowType=hud-overlay";
...
describe("isTrustedCaptureDocumentUrl", () => {
	...
	])("accepts a Reco HUD document: %s", (candidateUrl) => {
	...
	it.each([
		...
		"file:///C:/Program%20Files/Reco/resources/app.asar/dist/other.html?windowType=hud-overlay",
		"file:///C:/Program%20Files/Reco/resources/app.asar/dist/index.html/child?windowType=hud-overlay",
		"data:text/html,reco?windowType=hud-overlay",
		"not a url",
	])("rejects a non-Reco capture document: %s", (candidateUrl) => {
...
describe("shouldGrantDisplayCapture", () => {
	...
	it.each([
		["another BrowserWindow", { isTrustedCaptureWindow: false }],
		["a subframe", { isMainFrame: false }],
		["a non-Reco document", { currentDocumentUrl: "https://example.com/" }],
