...
export function getNativeCaptureHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "reco-screencapturekit-helper");
}
...
export function getSystemCursorHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "reco-system-cursors");
}
...
export function getNativeCursorMonitorBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "reco-native-cursor-monitor");
}
...
export function getNativeWindowListBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "reco-window-list");
}
