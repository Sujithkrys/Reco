...
export const PROJECT_FILE_EXTENSION = "reco";
...
export const ALLOW_RECO_WINDOW_CAPTURE = Boolean(process.env["VITE_DEV_SERVER_URL"]);
export const RECORDING_SESSION_MANIFEST_SUFFIX = ".reco-session.json";
